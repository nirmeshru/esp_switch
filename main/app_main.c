...
void app_main()
{
	...
	app_driver_set_state3(DEFAULT_POWER);
	app_driver_set_state4(DEFAULT_POWER);
	...
	switch_device4 = esp_rmaker_device_create("Switch4", ESP_RMAKER_DEVICE_SWITCH, NULL);	
	...
	esp_rmaker_device_add_param(switch_device4, esp_rmaker_name_param_create(ESP_RMAKER_DEF_NAME_PARAM, "Switch4"));
    ...
    esp_rmaker_device_add_param(switch_device4, power_param4);
	...
	esp_rmaker_device_assign_primary_param(switch_device4, power_param4);
